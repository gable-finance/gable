import { css as M, unsafeCSS as g, html as c, LitElement as I } from "lit";
import { property as r, customElement as p, state as Ne } from "lit/decorators.js";
import { classMap as T } from "lit/directives/class-map.js";
import { styleMap as de } from "lit/directives/style-map.js";
import { classMap as ue } from "lit-html/directives/class-map.js";
M`
  :host {
    /* Core colors */
...
var xe = Object.defineProperty, Ae = Object.getOwnPropertyDescriptor, F = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Ae(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
...
var De = Object.defineProperty, me = Object.getOwnPropertyDescriptor, w = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? me(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && De(o, a, t), t;
};
let m = class extends I {
  constructor() {
    super(...arguments), this.mode = u.light, this.connected = !1, this.compact = !1, this.isMobile = !1, this.height = 0;
  }
  connectedCallback() {
  ...
  drawPopover() {
    const e = this.mode === "light" ? "#D9D9D9" : "#808080", o = this.height, a = 13, i = 8, t = 344, d = o, n = 12, D = n / 2, se = `
  ...
  render() {
    return this.isMobile ? c`<div id="radix-mobile-popover-content">
          <button
            id="close-button"
            @click=${() => {
      this.closePopover();
...
const he = 32, ze = 32, G = 138, J = c`<div class="loading-spinner-container">
...
let y = class extends I {
  ...
  render() {
    const e = () => this.status === k.pending && this.connected ? c`${J} <slot></slot>` : this.status === k.pending ? J : !this.connected && ["success", "error"].includes(this.status) ? "" : c`<slot></slot>`, o = this.status !== "pending" && !this.connected, a = this.connected;
    return c`
      <button
        @click=${this.onClick}
        class=${T({
...
var Ve = Object.defineProperty, ke = Object.getOwnPropertyDescriptor, R = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? ke(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
...
let C = class extends I {
  ...
  render() {
    const e = () => this.timestamp ? c`<div class="timestamp">${ce(this.timestamp)}</div>` : "", o = `${this.icon ? "30px" : ""} 1fr ${this.timestamp ? "60px" : ""}`;
    return c`<div class="card" style=${de({ gridTemplateColumns: o })}>
      <i></i>
      <div class="content">
...
var Ue = Object.defineProperty, we = Object.getOwnPropertyDescriptor, f = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? we(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
...
let U = class extends I {
  ...
  render() {
    return c`<a target="_blank" href=${this.href} class="link"
      >${this.displayText}
...
var Le = Object.defineProperty, We = Object.getOwnPropertyDescriptor, O = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? We(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
...
var Re = Object.defineProperty, Oe = Object.getOwnPropertyDescriptor, z = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Oe(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
...
let x = class extends I {
  ...
  getRequestContentTemplate(e) {
    return this.status === "pending" ? c`<div class="request-content">
          ${e}
          ${this.showCancel ? c`<div class="cancel" @click=${this.onCancel}>Cancel</div>` : ""}
        </div>` : "";
  }
  getIconFromStatus() {
  ...
  renderTxIntentHash() {
    return this.transactionIntentHash ? c`<div class="transaction">
...
var Qe = Object.defineProperty, Ge = Object.getOwnPropertyDescriptor, X = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Ge(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
...
var fe = Object.defineProperty, Ye = Object.getOwnPropertyDescriptor, v = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Ye(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
...
let A = class extends I {
  ...
  render() {
    ...
    return this.isMobile ? e = this.renderMobileTemplate() : this.isExtensionAvailable ? this.isWalletLinked ? this.status === k.pending && (e = this.renderRequestItemsTemplate()) : e = this.renderCeNotLinkedTemplate() : e = this.renderCeNotInstalledTemplate(), c`
  ...
  renderMobileTemplate() {
    return c` <div class="mobile-wrapper">
  ...
  renderConnectTemplate() {
    return c` ${this.connectNowButtonTemplate()} `;
  }
};
A.styles = [
  N,
...
var Xe = Object.defineProperty, Be = Object.getOwnPropertyDescriptor, S = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Be(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && Xe(o, a, t), t;
};
let h = class extends I {
  ...
  render() {
    return c`<radix-card mode=${this.mode}>
      <div
        class=${T({
      ...
      >
        <div class="placeholder">
          <div
            class="avatar"
            style=${de({
      backgroundImage: `url(${g(this.avatarUrl)})`
    })}
          ></div>
        </div>
        <div class="content">
          ...
          <ul>
            ${(this.personaData || []).map((e) => c`<li>${e}</li>`)}
          </ul>
        </div>
      </div></radix-card
    >`;
...
`;
var He = Object.defineProperty, Pe = Object.getOwnPropertyDescriptor, V = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Pe(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
...
let b = class extends I {
  ...
  render() {
    return c` <div class="header">Sharing with ${this.dAppName}</div>
      <div class="content">
        <radix-persona-card
        ...
        <div>
          ${(this.accounts || []).map(
      ({ label: e, address: o, appearanceId: a }) => c`<radix-account
                label=${e}
                address=${o}
                appearanceId=${a}
              ></radix-account>`
...
b.styles = [
  ...
  M`
      ...
      #update-data::before {
        -webkit-mask-image: url(${g(re)});
        mask-image: url(${g(re)});
      }

      #logout::before {
        -webkit-mask-image: url(${g(ne)});
        mask-image: url(${g(ne)});
      }
    `
];
...
var Je = Object.defineProperty, Ke = Object.getOwnPropertyDescriptor, Q = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Ke(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
...
let j = class extends I {
  ...
  render() {
    return c`
      ...
      ${this.loggedInTimestamp ? c`<div class="subheader">
...
var qe = Object.defineProperty, $e = Object.getOwnPropertyDescriptor, s = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? $e(o, a) : o, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && qe(o, a, t), t;
};
let l = class extends I {
  ...
  connectTemplate() {
    if (!this.connected)
      return c` <radix-not-connected-page
      mode=${this.mode}
      status=${this.status}
  ...
  popoverTemplate() {
    return this.showPopoverMenu ? c` <radix-popover
      mode="${this.mode}"
      ?connected=${this.connected}
  ...
  render() {
    return c`${this.connectButtonTemplate()} ${this.popoverTemplate()}`;
  }
};
l.styles = M`

...
mod flashloanpooltest {
    ...
    impl Flashloanpooltest {
        pub fn instantiate_flashloan_pool(
            owner_badge: Bucket, 
            validator_owner: Bucket, 
            lsu_address: ResourceAddress,
            unstake_nft_address: ResourceAddress
        ) -> (Bucket, FungibleBucket, Global<Flashloanpooltest>) {
            let (address_reservation, component_address) =
                Runtime::allocate_component_address(Flashloanpooltest::blueprint_id());
            ...
            let flashloan_component: Global<Flashloanpooltest> = Self {
            ...
            .metadata(metadata! {
                ...
                init {
                    "name" => "TEST: Gable: Flash Loan Pool", locked;
                    "description" => 
                        "TEST: Gable 'XRD flash loan pool' component that

...
import { WalletSdk, Account, NumberOfAccounts, Persona, PersonaDataField, PersonaData } from '@radixdlt/wallet-sdk';
...
export type SendTransactionRequestValue = Parameters<WalletSdk['sendTransaction']>[0];
export type State = {
    connected: boolean;
    accounts?: Account[];
...
export type DataRequestInput<IsLoginRequest extends boolean = false> = IsLoginRequest extends true ? {
...
export type OnConnectCallback = (result: RequestDataResponse, done: () => void) => void;
export type OnInitCallback = (state: State) => void;
export type OnDisconnectCallback = () => void;
export type OnResetCallback = (value: (value: DataRequestInput<true>) => RequestDataOutput) => any;
...
export type OnConnect = (value: (value: DataRequestInput<true>) => RequestDataOutput) => any;

import { css as M, html as g, unsafeCSS as c, LitElement as I } from "lit";
import { property as r, customElement as p, state as pe } from "lit/decorators.js";
...
var xe = Object.defineProperty, Ae = Object.getOwnPropertyDescriptor, f = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Ae(a, o) : a, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && xe(a, o, t), t;
};
...
var De = Object.defineProperty, me = Object.getOwnPropertyDescriptor, L = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? me(a, o) : a, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && De(a, o, t), t;
};
let T = class extends I {
  ...
  drawPopover() {
    const e = this.mode === "light" ? "#D9D9D9" : "#808080", a = this.height, o = 13, i = 8, t = 344, d = a, n = 12, D = n / 2, se = `
      ...
      </linearGradient>`, le = (F, B, H) => `
      L ${F - H} ${B} 
      L ${F} 1
      L ${F + H} ${B}`, Me = this.compact ? t - 30 : 300, Ie = `
...
const he = 32, ze = 32, G = 138, P = g`<div class="loading-spinner-container">
...
var Ce = Object.defineProperty, je = Object.getOwnPropertyDescriptor, W = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? je(a, o) : a, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && Ce(a, o, t), t;
};
let y = class extends I {
  ...
  disconnectedCallback() {
    ...
    (e = this.resizeObserver) == null || e.unobserve(a);
  }
  render() {
    const e = () => this.status === k.pending && this.connected ? g`${P} <slot></slot>` : this.status === k.pending ? P : !this.connected && ["success", "error"].includes(this.status) ? "" : g`<slot></slot>`, a = this.status !== "pending" && !this.connected, o = this.connected;
    return g`
      <button
        @click=${this.onClick}
        class=${z({
...
const _ = "data:image/svg+xml;base64,", ee = "data:image/svg+xml;base64,", te = "data:image/svg+xml;base64,", ae = "data:image/svg+xml;base64,", ve = (e) => {
  ...
  const o = new Date(Number(e)), i = ve(o), t = o.toLocaleTimeString("en-Gb", {
    // en-GB is causing midnight to be 00:00
    hour: "numeric",
    minute: "numeric",
    hour12: !1
  });
  return i ? `Today${a}${t}` : `${o.getDate()} ${o.toLocaleString("en-US", {
    month: "short"
  })}${a}${t}`;
};
var Ve = Object.defineProperty, ke = Object.getOwnPropertyDescriptor, R = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? ke(a, o) : a, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && Ve(a, o, t), t;
};
let Z = class extends I {
  ...
  render() {
    const e = () => this.timestamp ? g`<div class="timestamp">${de(this.timestamp)}</div>` : "", a = `${this.icon ? "30px" : ""} 1fr ${this.timestamp ? "60px" : ""}`;
    return g`<div class="card" style=${ne({ gridTemplateColumns: a })}>
      <i></i>
      <div class="content">
...
var Ue = Object.defineProperty, Se = Object.getOwnPropertyDescriptor, Y = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Se(a, o) : a, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && Ue(a, o, t), t;
};
...
], C.prototype, "appearanceId", 2);
C = O([
  p("radix-account")
], C);
var Re = Object.defineProperty, Oe = Object.getOwnPropertyDescriptor, h = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Oe(a, o) : a, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && Re(a, o, t), t;
};
let x = class extends I {
  ...
  render() {
    const e = this.getIconFromStatus(), a = this.getStylingFromStatus(), o = {
      sendTransaction: {
    ...
    return g`<radix-card
      ...
      header="${o[this.type][this.status]}"
    >
      ${o[this.type].content}
    </radix-card>`;
  }
...
var Qe = Object.defineProperty, Ge = Object.getOwnPropertyDescriptor, X = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Ge(a, o) : a, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && Qe(a, o, t), t;
};
...
X([
  r({ type: Array })
], E.prototype, "requestItems", 2);
E = X([
  p("radix-request-cards")
], E);
var Ye = Object.defineProperty, Fe = Object.getOwnPropertyDescriptor, v = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Fe(a, o) : a, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && Ye(a, o, t), t;
};
let A = class extends I {
  constructor() {
    super(...arguments), this.mode = u.light, this.isMobile = !1, this.status = k.default, this.isWalletLinked = !1, this.isExtensionAvailable = !1, this.requestItems = [];
  }
  render() {
    let e = this.renderConnectTemplate();
    return this.isMobile ? e = this.renderMobileTemplate() : this.isExtensionAvailable ? this.isWalletLinked ? this.status === k.pending && (e = this.renderRequestItemsTemplate()) : e = this.renderCeNotLinkedTemplate() : e = this.renderCeNotInstalledTemplate(), g`
      <div class="wrapper connect-your-wallet">
        <img class="logo" src=${we} />
...
var Xe = Object.defineProperty, Be = Object.getOwnPropertyDescriptor, S = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Be(a, o) : a, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && Xe(a, o, t), t;
};
...
`;
var He = Object.defineProperty, Pe = Object.getOwnPropertyDescriptor, V = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Pe(a, o) : a, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && He(a, o, t), t;
};
  ...
  render() {
    return g` <div class="header">Sharing with ${this.dAppName}</div>
      <div class="content">
        ...
        <div>
          ${(this.accounts || []).map(
      ({ label: e, address: a, appearanceId: o }) => g`<radix-account
                label=${e}
                address=${a}
                appearanceId=${o}
              ></radix-account>`
...
var Je = Object.defineProperty, Ke = Object.getOwnPropertyDescriptor, Q = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Ke(a, o) : a, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && Je(a, o, t), t;
};
  ...
  render() {
    return g`
      ...
      ${this.loggedInTimestamp ? g`<div class="subheader">
            Since logged in: ${de(this.loggedInTimestamp, ", ")}
          </div>` : ""}
      <div class="content">
...
let s = class extends I {
  ...
  popoverTemplate() {
    return this.showPopover ? g` <radix-popover
      mode="${this.mode}"
      ?connected=${this.connected}
...
l([
  r({ type: String })
], s.prototype, "dAppName", 2);
l([
  r({ type: String })
], s.prototype, "personaLabel", 2);
l([
  r({ type: Boolean })
], s.prototype, "connected", 2);
l([
  r({
    type: String
  })
...
l([
  r({ type: String })
], s.prototype, "loggedInTimestamp", 2);
l([
  r({
    type: Boolean
  })
], s.prototype, "showPopover", 2);
l([
  r({ type: Array })
], s.prototype, "requestItems", 2);
l([
  r({ type: Array })
], s.prototype, "accounts", 2);
l([
  r({
    type: Array
  })
], s.prototype, "personaData", 2);
l([
  r({
    type: Boolean
  })
], s.prototype, "isMobile", 2);
l([
  r({
    type: Boolean
  })
], s.prototype, "isWalletLinked", 2);
l([
  r({
    type: Boolean
  })
], s.prototype, "isExtensionAvailable", 2);
l([
  r({
    type: Boolean
  })
...
l([
  r({ type: String })
], s.prototype, "avatarUrl", 2);
l([
  r({ type: Boolean, state: !0 })

 ...
 * @export
 */
export declare const NonFungibleResourcesCollectionItemGloballyAggregatedAllOfAggregationLevelEnum: {
 ...
 */
export declare function instanceOfNonFungibleResourcesCollectionItemGloballyAggregatedAllOf(value: object): boolean;
export declare function NonFungibleResourcesCollectionItemGloballyAggregatedAllOfFromJSON(json: any): NonFungibleResourcesCollectionItemGloballyAggregatedAllOf;
export declare function NonFungibleResourcesCollectionItemGloballyAggregatedAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): NonFungibleResourcesCollectionItemGloballyAggregatedAllOf;
export declare function NonFungibleResourcesCollectionItemGloballyAggregatedAllOfToJSON(value?: NonFungibleResourcesCollectionItemGloballyAggregatedAllOf | null): any;

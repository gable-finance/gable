(function(g,o){typeof exports=="object"&&typeof module<"u"?o(exports,require("lit"),require("lit/decorators.js"),require("lit/directives/class-map.js"),require("lit/directives/style-map.js"),require("lit-html/directives/class-map.js")):typeof define=="function"&&define.amd?define(["exports","lit","lit/decorators.js","lit/directives/class-map.js","lit/directives/style-map.js","lit-html/directives/class-map.js"],o):(g=typeof globalThis<"u"?globalThis:g||self,o(g["connect-button"]={},g.lit,g.decorators_js,g.classMap_js,g.styleMap_js,g.classMap_js$1))})(this,function(g,o,r,m,G,ce){"use strict";const qe="",$e="";o.css`
  :host {
    /* Core colors */
...
`,D={pending:"pending",success:"success",error:"error",default:"default"},le={"radix-blue":"radix-blue",black:"black","white-with-outline":"white-with-outline",white:"white"},M={light:"light",dark:"dark"},ge={pending:"pending",success:"success",fail:"fail",cancelled:"cancelled"},se={loginRequest:"loginRequest",dataRequest:"dataRequest",sendTransaction:"sendTransaction"};var de=Object.defineProperty,Me=Object.getOwnPropertyDescriptor,f=(e,a,i,n)=>{for(var t=n>1?void 0:n?Me(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&de(a,i,t),t};let V=class extends o.LitElement{constructor(){super(...arguments),this.theme=M.light,this.active="sharing"}onClick(e,a){this.dispatchEvent(new CustomEvent("onClick",{detail:{value:e,event:a},bubbles:!0,composed:!0}))}render(){return o.html`
      <div class="tabs">
        <button
    ...
    `],f([r.property({type:String,reflect:!0})],V.prototype,"theme",2),f([r.property({type:String,reflect:!0})],V.prototype,"active",2),V=f([r.customElement("radix-tabs-menu")],V);const pe=e=>{if(typeof btoa=="function")return btoa(e);if(typeof Buffer=="function")return Buffer.from(e,"utf-8").toString("base64");throw new Error("Failed to determine the platform specific encoder")},Y="data:image/svg+xml;base64,";var Ie=Object.defineProperty,ue=Object.getOwnPropertyDescriptor,j=(e,a,i,n)=>{for(var t=n>1?void 0:n?ue(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&Ie(a,i,t),t};let N=class extends o.LitElement{constructor(){super(...arguments),this.mode=M.light,this.connected=!1,this.compact=!1,this.isMobile=!1,this.height=0}connectedCallback(){super.connectedCallback(),setTimeout(()=>{const e=this.shadowRoot.getElementById("radix-popover-content");this.resizeObserver=new ResizeObserver(()=>{e&&e.scrollHeight&&(this.height=e.scrollHeight)}),this.resizeObserver.observe(this)})}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.resizeObserver)==null||e.unobserve(this)}closePopover(){this.dispatchEvent(new CustomEvent("onClosePopover",{bubbles:!0,composed:!0}))}drawPopover(){const e=this.mode==="light"?"#D9D9D9":"#808080",a=this.height,i=13,n=8,t=344,l=a,c=12,b=c/2,Pe=`
      ...
      </linearGradient>`,He=(Q,ne,ie)=>`
      L ${Q-ie} ${ne} 
      L ${Q} 1
      L ${Q+ie} ${ne}`,Je=this.compact?t-30:300,Ke=`
    <svg viewBox="0 0 345 ${a+1}"  fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"  >
        <path
            d="${[`M ${i} ${n}`,He(Je,n,7),`L ${t-c} ${n}`,`C ${t-b} ${n} ${t} ${n+b} ${t} ${n+c}`,`L ${t} ${l-c}`,`C ${t} ${l-b} ${t-b} ${l} ${t-c} ${l}`,`L ${i} ${l}`,`C ${i-b} ${l} ${i-c} ${l-b} ${i-c} ${l-c}`,`L ${i-c} ${n+c}`,`C ${i-c} ${n+b} ${i-b} ${n} ${i} ${n}`,"Z"].join(" ")}"
    ...
    `;return`data:image/svg+xml;base64,${pe(Ke)}`}render(){return this.isMobile?o.html`<div id="radix-mobile-popover-content">
          <button
            id="close-button"
      ...
      #close-button {
        -webkit-mask-image: url(${o.unsafeCSS(Y)});
        mask-image: url(${o.unsafeCSS(Y)});
    ...
    `],j([r.property({type:String,reflect:!0})],N.prototype,"mode",2),j([r.property({type:Boolean})],N.prototype,"connected",2),j([r.property({type:Boolean})],N.prototype,"compact",2),j([r.property({type:Boolean})],N.prototype,"isMobile",2),j([r.state()],N.prototype,"height",2),N=j([r.customElement("radix-popover")],N);const Ne=32,xe=32,R=138,F=o.html`<div class="loading-spinner-container">
...
`,X="data:image/svg+xml;base64,",be="data:image/svg+xml;base64,",me="data:image/svg+xml;base64,",B="data:image/svg+xml;base64,",P="data:image/svg+xml;base64,",H="data:image/svg+xml;base64,";var De=Object.defineProperty,he=Object.getOwnPropertyDescriptor,U=(e,a,i,n)=>{for(var t=n>1?void 0:n?he(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&De(a,i,t),t};let h=class extends o.LitElement{constructor(){super(...arguments),this.status=D.default,this.connected=!1,this.fullWidth=!1,this.theme="radix-blue"}onClick(e){this.dispatchEvent(new CustomEvent("onClick",{detail:e,bubbles:!0,composed:!0}))}connectedCallback(){super.connectedCallback(),setTimeout(()=>{const e=this.shadowRoot.querySelector("button");this.resizeObserver=new ResizeObserver(()=>{this.dispatchEvent(new CustomEvent("onResize",{bubbles:!0,composed:!1,detail:e}))}),this.resizeObserver.observe(e)})}disconnectedCallback(){var a;super.disconnectedCallback();const e=this.shadowRoot.querySelector("button");(a=this.resizeObserver)==null||a.unobserve(e)}render(){const e=()=>this.status===D.pending&&this.connected?o.html`${F} <slot></slot>`:this.status===D.pending?F:!this.connected&&["success","error"].includes(this.status)?"":o.html`<slot></slot>`,a=this.status!=="pending"&&!this.connected,i=this.connected;return o.html`
    ...
    `}};h.styles=[d,Ae,o.css`
      ...
      button.logo::before {
        content: '';
        mask-image: url(${o.unsafeCSS(X)});
        -webkit-mask-image: url(${o.unsafeCSS(X)});
      }
      ...
      button.gradient {
        ...
        background-color: var(--color-radix-blue-2);
        color: var(--color-light);
        background-image: url(${o.unsafeCSS(be)});
        padding-right: 7px;
      }
      ...
      :host([status='default']) > button.gradient::before {
        mask-image: url(${o.unsafeCSS(B)});
        -webkit-mask-image: url(${o.unsafeCSS(B)});
        width: 22px;
        min-width: 22px;
        height: 22px;
      ...
      :host([status='success']) > button::before {
        mask-image: url(${o.unsafeCSS(P)});
        -webkit-mask-image: url(${o.unsafeCSS(P)});
        width: 22px;
        min-width: 22px;
        height: 22px;
        -webkit-mask-position: center;
      ...
      :host([status='error']) > button::before {
        mask-image: url(${o.unsafeCSS(H)});
        -webkit-mask-image: url(${o.unsafeCSS(H)});
        width: 22px;
        min-width: 22px;
        height: 22px;
        -webkit-mask-position: center;
      ...
      @container (width < ${R-.1}px) {
        ...
        button.gradient {
          background-image: url(${o.unsafeCSS(me)});
          padding: 0;
        }
        button.logo::before {
          font-size: 16px;
    ...
    `],U([r.property({type:String,reflect:!0})],h.prototype,"status",2),U([r.property({type:Boolean})],h.prototype,"connected",2),U([r.property({type:Boolean,reflect:!0})],h.prototype,"fullWidth",2),U([r.property({type:String,reflect:!0})],h.prototype,"theme",2),h=U([r.customElement("radix-button")],h);const J="data:image/svg+xml;base64,",K="data:image/svg+xml;base64,",q="data:image/svg+xml;base64,",$="data:image/svg+xml;base64,",Ce=e=>{const a=new Date;return e.getDate()==a.getDate()&&e.getMonth()==a.getMonth()&&e.getFullYear()==a.getFullYear()},_=(e,a=" ")=>{const i=new Date(Number(e)),n=Ce(i),t=i.toLocaleTimeString("en-Gb",{hour:"numeric",minute:"numeric",hour12:!1});return n?`Today${a}${t}`:`${i.getDate()} ${i.toLocaleString("en-US",{month:"short"})}${a}${t}`};var ye=Object.defineProperty,Te=Object.getOwnPropertyDescriptor,w=(e,a,i,n)=>{for(var t=n>1?void 0:n?Te(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&ye(a,i,t),t};let C=class extends o.LitElement{constructor(){super(...arguments),this.mode=M.light,this.header=""}render(){const e=()=>this.timestamp?o.html`<div class="timestamp">${_(this.timestamp)}</div>`:"",a=`${this.icon?"30px":""} 1fr ${this.timestamp?"60px":""}`;return o.html`<div class="card" style=${G.styleMap({gridTemplateColumns:a})}>
      ...
      :host([icon='unchecked']) i::before {
        -webkit-mask-image: url(${o.unsafeCSS(J)});
        mask-image: url(${o.unsafeCSS(J)});
        width: 24px;
        height: 24px;
      }

      :host([icon='pending']) i::before {
        -webkit-mask-image: url(${o.unsafeCSS(q)});
        mask-image: url(${o.unsafeCSS(q)});
        width: 24px;
        height: 24px;
      }

      :host([icon='checked']) i::before {
        -webkit-mask-image: url(${o.unsafeCSS(K)});
        mask-image: url(${o.unsafeCSS(K)});
        width: 24px;
        height: 24px;
      }

      :host([icon='error']) i::before {
        -webkit-mask-image: url(${o.unsafeCSS($)});
        mask-image: url(${o.unsafeCSS($)});
        width: 24px;
        height: 24px;
      }
    `],w([r.property({type:String,reflect:!0})],C.prototype,"mode",2),w([r.property({type:String,reflect:!0})],C.prototype,"icon",2),w([r.property({type:String})],C.prototype,"header",2),w([r.property({type:String,reflect:!0})],C.prototype,"timestamp",2),C=w([r.customElement("radix-card")],C);const ee="data:image/svg+xml;base64,";var ze=Object.defineProperty,Ze=Object.getOwnPropertyDescriptor,W=(e,a,i,n)=>{for(var t=n>1?void 0:n?Ze(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&ze(a,i,t),t};let v=class extends o.LitElement{constructor(){super(...arguments),this.mode=M.light,this.href="",this.displayText=""}render(){return o.html`<a target="_blank" href=${this.href} class="link"
      >${this.displayText}
    ...
    `],W([r.property({type:String,reflect:!0})],v.prototype,"mode",2),W([r.property({type:String})],v.prototype,"href",2),W([r.property({type:String})],v.prototype,"displayText",2),v=W([r.customElement("radix-link")],v);const je="data:image/png;base64,",ve="data:image/svg+xml;base64,",te=e=>e?`${e.slice(0,4)}...${e.slice(e.length-6,e.length)}`:"";var Se=Object.defineProperty,Ve=Object.getOwnPropertyDescriptor,E=(e,a,i,n)=>{for(var t=n>1?void 0:n?Ve(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&Se(a,i,t),t};let y=class extends o.LitElement{constructor(){super(...arguments),this.mode=M.light,this.address="",this.label="",this.appearanceId=0}formatAccountLabel(e){return e.length>14?`${e.slice(0,12).trimEnd()}...`:e}render(){return o.html` <span class="label"
      ...
      i {
        background-image: url(${o.unsafeCSS(ve)});
        display: inline-block;
        background-repeat: no-repeat;
        background-size: cover;
    ...
    >
      ${i[this.type].content}
    </radix-card>`}getRequestContentTemplate(e){return this.status==="pending"?o.html`<div class="request-content">
          ${e}
          ${this.showCancel?o.html`<div class="cancel" @click=${this.onCancel}>Cancel</div>`:""}
        </div>`:""}getIconFromStatus(){return this.status==="pending"?"pending":this.status==="cancelled"||this.status==="fail"?"error":"checked"}getStylingFromStatus(){return m.classMap({dimmed:this.status==="fail"||this.status==="cancelled",inverted:this.status==="pending"})}onCancel(e){this.dispatchEvent(new CustomEvent("onCancelRequestItem",{detail:{...e,id:this.id},bubbles:!0,composed:!0}))}renderTxIntentHash(){return this.transactionIntentHash?o.html`<div class="transaction">
          <span class="text-dimmed">ID:</span>
          <radix-link
            displayText="${te(this.transactionIntentHash)}"
            mode=${this.mode}
    ...
    `],x([r.property({type:String,reflect:!0})],p.prototype,"mode",2),x([r.property({type:String})],p.prototype,"type",2),x([r.property({type:String})],p.prototype,"status",2),x([r.property({type:Boolean})],p.prototype,"showCancel",2),x([r.property({type:String})],p.prototype,"timestamp",2),x([r.property({type:String})],p.prototype,"id",2),x([r.property({type:String})],p.prototype,"transactionIntentHash",2),p=x([r.customElement("radix-request-card")],p);var Ee=Object.defineProperty,ke=Object.getOwnPropertyDescriptor,O=(e,a,i,n)=>{for(var t=n>1?void 0:n?ke(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&Ee(a,i,t),t};let k=class extends o.LitElement{constructor(){super(...arguments),this.mode=M.light,this.requestItems=[]}render(){return(this.requestItems||[]).map(e=>o.html`<radix-request-card
        type="${e.type}"
        status="${e.status}"
        id="${e.id}"
        ...
        mode=${this.mode}
      ></radix-request-card>`)}};k.styles=[d],O([r.property({type:String,reflect:!0})],k.prototype,"mode",2),O([r.property({type:Array})],k.prototype,"requestItems",2),k=O([r.customElement("radix-request-cards")],k);var Le=Object.defineProperty,Re=Object.getOwnPropertyDescriptor,T=(e,a,i,n)=>{for(var t=n>1?void 0:n?Re(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&Le(a,i,t),t};let I=class extends o.LitElement{constructor(){super(...arguments),this.mode=M.light,this.isMobile=!1,this.status=D.default,this.isWalletLinked=!1,this.isExtensionAvailable=!1,this.requestItems=[]}render(){let e=this.renderConnectTemplate();return this.isMobile?e=this.renderMobileTemplate():this.isExtensionAvailable?this.isWalletLinked?this.status===D.pending&&(e=this.renderRequestItemsTemplate()):e=this.renderCeNotLinkedTemplate():e=this.renderCeNotInstalledTemplate(),o.html`
      <div class="wrapper connect-your-wallet">
        <img class="logo" src=${je} />
        <span class="text connect">Connect Your Radix Wallet</span>
      </div>
      ${e}
    `}renderMobileTemplate(){return o.html` <div class="mobile-wrapper">
      <div class="header">Mobile dApps are coming soon.</div>
      <div class="content">
        For now, please connect to Radix dApps using a desktop web browser.
      </div>
    </div>`}renderRequestItemsTemplate(){return o.html`<radix-request-cards
      class="request-cards"
      mode=${this.mode}
      .requestItems=${this.requestItems}
    ></radix-request-cards>`}connectNowButtonTemplate(){const e=!this.isExtensionAvailable||!this.isWalletLinked;return o.html`<button
      class="${m.classMap({"connect-now":!0,disabled:e})}"
      @click=${()=>{e||this.dispatchEvent(new CustomEvent("onConnect",{bubbles:!0,composed:!0}))}}
    >
      Connect Now
    </button>`}renderCeNotInstalledTemplate(){return o.html`<div class="info">
      ...
      ${this.connectNowButtonTemplate()} `}renderCeNotLinkedTemplate(){return o.html`<div class="info">
      ...
      ${this.connectNowButtonTemplate()} `}renderConnectTemplate(){return o.html` ${this.connectNowButtonTemplate()} `}};I.styles=[d,o.css`
      :host {
        width: 100%;
      }
    ...
    `],T([r.property({type:String,reflect:!0})],I.prototype,"mode",2),T([r.property({type:Boolean})],I.prototype,"isMobile",2),T([r.property({type:String})],I.prototype,"status",2),T([r.property({type:Boolean})],I.prototype,"isWalletLinked",2),T([r.property({type:Boolean})],I.prototype,"isExtensionAvailable",2),T([r.property({type:Array})],I.prototype,"requestItems",2),I=T([r.customElement("radix-not-connected-page")],I);const We="data:image/svg+xml;base64,";var fe=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor,S=(e,a,i,n)=>{for(var t=n>1?void 0:n?Oe(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&fe(a,i,t),t};let A=class extends o.LitElement{constructor(){super(...arguments),this.mode=M.light,this.persona="",this.personaData=[]}render(){return o.html`<radix-card mode=${this.mode}>
      ...
      >
        <div class="placeholder">
          <div
            class="avatar"
            style=${G.styleMap({backgroundImage:`url(${o.unsafeCSS(this.avatarUrl)})`})}
          ></div>
        </div>
        <div class="content">
          <span class="persona">${this.persona}</span>
          <ul>
            ${(this.personaData||[]).map(e=>o.html`<li>${e}</li>`)}
          </ul>
        </div>
      </div></radix-card
    >`}};A.styles=[d,o.css`
      ...
      .placeholder {
        width: 64px;
        height: 64px;
        background-image: url(${o.unsafeCSS(We)});
      }
...
`;var Qe=Object.defineProperty,Ge=Object.getOwnPropertyDescriptor,z=(e,a,i,n)=>{for(var t=n>1?void 0:n?Ge(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&Qe(a,i,t),t};let u=class extends o.LitElement{constructor(){super(...arguments),this.mode=M.light,this.avatarUrl="",this.persona="",this.dAppName="",this.personaData=[],this.accounts=[]}onUpdateData(e){this.dispatchEvent(new CustomEvent("onUpdateData",{detail:e,bubbles:!0,composed:!0}))}onLogout(e){this.dispatchEvent(new CustomEvent("onLogout",{detail:e,bubbles:!0,composed:!0}))}render(){return o.html` <div class="header">Sharing with ${this.dAppName}</div>
      <div class="content">
        <radix-persona-card
        ...
        ></radix-persona-card>
        <div>
          ${(this.accounts||[]).map(({label:e,address:a,appearanceId:i})=>o.html`<radix-account
                label=${e}
                address=${a}
                appearanceId=${i}
              ></radix-account>`)}
      ...
      #update-data::before {
        -webkit-mask-image: url(${o.unsafeCSS(oe)});
        mask-image: url(${o.unsafeCSS(oe)});
      }

      #logout::before {
        -webkit-mask-image: url(${o.unsafeCSS(ae)});
        mask-image: url(${o.unsafeCSS(ae)});
      }
    `],z([r.property({type:String,reflect:!0})],u.prototype,"mode",2),z([r.property({type:String})],u.prototype,"avatarUrl",2),z([r.property({type:String})],u.prototype,"persona",2),z([r.property({type:String})],u.prototype,"dAppName",2),z([r.property({type:Array})],u.prototype,"personaData",2),z([r.property({type:Array})],u.prototype,"accounts",2),u=z([r.customElement("radix-sharing-page")],u);var Ye=Object.defineProperty,Fe=Object.getOwnPropertyDescriptor,L=(e,a,i,n)=>{for(var t=n>1?void 0:n?Fe(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&Ye(a,i,t),t};let Z=class extends o.LitElement{constructor(){super(...arguments),this.mode=M.light,this.requestItems=[],this.dAppName="",this.loggedInTimestamp=""}render(){return o.html`
      <div class="header">Connected to ${this.dAppName}</div>
      <slot name="subheader"></slot>
      ${this.loggedInTimestamp?o.html`<div class="subheader">
            Since logged in: ${_(this.loggedInTimestamp,", ")}
          </div>`:""}
      <div class="content">
        ${(this.requestItems||[]).map(e=>o.html`<radix-request-card
            type="${e.type}"
            status="${e.status}"
            id="${e.id}"
    ...
    `],L([r.property({type:String,reflect:!0})],Z.prototype,"mode",2),L([r.property({type:Array})],Z.prototype,"requestItems",2),L([r.property({type:String})],Z.prototype,"dAppName",2),L([r.property({type:String})],Z.prototype,"loggedInTimestamp",2),Z=L([r.customElement("radix-requests-page")],Z);var Xe=Object.defineProperty,Be=Object.getOwnPropertyDescriptor,s=(e,a,i,n)=>{for(var t=n>1?void 0:n?Be(a,i):a,l=e.length-1,c;l>=0;l--)(c=e[l])&&(t=(n?c(a,i,t):c(t))||t);return n&&t&&Xe(a,i,t),t};g.ConnectButton=class extends o.LitElement{constructor(){super(),this.theme="radix-blue",this.dAppName="",this.personaLabel="",this.connected=!1,this.status=D.default,this.loggedInTimestamp="",this.showPopoverMenu=!1,this.requestItems=[],this.accounts=[],this.personaData=[],this.isMobile=!1,this.isWalletLinked=!1,this.isExtensionAvailable=!1,this.fullWidth=!1,this.activeTab="sharing",this.mode="light",this.avatarUrl="",this.compact=!1,this.windowClickEventHandler=a=>{this.showPopoverMenu&&(this.contains(a.target)||(this.showPopoverMenu=!1))},document.addEventListener("click",this.windowClickEventHandler)}get hasSharedData(){return!!(this.accounts.length||this.personaData.length)}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent("onRender",{bubbles:!0,composed:!0}))}disconnectedCallback(){document.removeEventListener("click",this.windowClickEventHandler),this.dispatchEvent(new CustomEvent("onDestroy",{bubbles:!0,composed:!0}))}togglePopoverMenu(){this.showPopoverMenu=!this.showPopoverMenu,this.showPopoverMenu&&this.dispatchEvent(new CustomEvent("onShowPopoverMenu",{bubbles:!0,composed:!0}))}closePopover(){this.showPopoverMenu=!1}connectButtonTemplate(){const a=this.connected?this.personaLabel:"Connect";return o.html` <radix-button
      status=${this.status}
      theme=${this.theme}
    ...
    >`}connectTemplate(){if(!this.connected)return o.html` <radix-not-connected-page
      mode=${this.mode}
      status=${this.status}
    ...
    >
    </radix-not-connected-page>`}renderSharingTemplate(){return o.html` <radix-sharing-page
      mode=${this.mode}
    ...
    ></radix-sharing-page>`}renderRequestItemsTemplate(){return o.html` <radix-requests-page
      mode=${this.mode}
      loggedInTimestamp=${this.loggedInTimestamp}
      dAppName=${this.dAppName}
      .requestItems=${this.requestItems}
    ></radix-requests-page>`}popoverTemplate(){return this.showPopoverMenu?o.html` <radix-popover
      mode="${this.mode}"
      ?connected=${this.connected}
      ?compact=${this.compact}
      ?isMobile=${this.isMobile}
      @onClosePopover=${()=>{this.closePopover()}}
      class=${ce.classMap({popover:!0,"show-popover":this.showPopoverMenu,mobile:this.isMobile})}
    >
      ${this.connected?o.html`
            <radix-tabs-menu
    ...
    </radix-popover>`:""}render(){return o.html`${this.connectButtonTemplate()} ${this.popoverTemplate()}`}},g.ConnectButton.styles=o.css`
  ...
  `,s([r.property({type:String})],g.ConnectButton.prototype,"theme",2),s([r.property({type:String})],g.ConnectButton.prototype,"dAppName",2),s([r.property({type:String})],g.ConnectButton.prototype,"personaLabel",2),s([r.property({type:Boolean})],g.ConnectButton.prototype,"connected",2),s([r.property({type:String})],g.ConnectButton.prototype,"status",2),s([r.property({type:String})],g.ConnectButton.prototype,"loggedInTimestamp",2),s([r.property({type:Boolean})],g.ConnectButton.prototype,"showPopoverMenu",2),s([r.property({type:Array})],g.ConnectButton.prototype,"requestItems",2),s([r.property({type:Array})],g.ConnectButton.prototype,"accounts",2),s([r.property({type:Array})],g.ConnectButton.prototype,"personaData",2),s([r.property({type:Boolean})],g.ConnectButton.prototype,"isMobile",2),s([r.property({type:Boolean})],g.ConnectButton.prototype,"isWalletLinked",2),s([r.property({type:Boolean})],g.ConnectButton.prototype,"isExtensionAvailable",2),s([r.property({type:Boolean})],g.ConnectButton.prototype,"fullWidth",2),s([r.property({type:String})],g.ConnectButton.prototype,"activeTab",2),s([r.property({type:String})],g.ConnectButton.prototype,"mode",2),s([r.property({type:String})],g.ConnectButton.prototype,"avatarUrl",2),s([r.property({type:Boolean,state:!0})],g.ConnectButton.prototype,"compact",2),g.ConnectButton=s([r.customElement("radix-connect-button")],g.ConnectButton),g.RadixButtonMode=M,g.RadixButtonStatus=D,g.RadixButtonTheme=le,g.RequestItemType=se,g.RequestStatus=ge,Object.defineProperty(g,Symbol.toStringTag,{value:"Module"})});

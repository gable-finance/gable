import { css as M, LitElement as I, html as s, unsafeCSS as d } from "lit";
import { property as i, customElement as p, state as pe } from "lit/decorators.js";
import { classMap as T } from "lit/directives/class-map.js";
import { styleMap as ne } from "lit/directives/style-map.js";
import { classMap as Ne } from "lit-html/directives/class-map.js";
const ue = {
...
var xe = Object.defineProperty, Ae = Object.getOwnPropertyDescriptor, F = (e, a, r, o) => {
  for (var t = o > 1 ? void 0 : o ? Ae(a, r) : a, c = e.length - 1, n; c >= 0; c--)
    (n = e[c]) && (t = (o ? n(a, r, t) : n(t)) || t);
  return o && t && xe(a, r, t), t;
};
...
var De = Object.defineProperty, me = Object.getOwnPropertyDescriptor, L = (e, a, r, o) => {
  for (var t = o > 1 ? void 0 : o ? me(a, r) : a, c = e.length - 1, n; c >= 0; c--)
    (n = e[c]) && (t = (o ? n(a, r, t) : n(t)) || t);
  return o && t && De(a, r, t), t;
};
let z = class extends I {
  constructor() {
    super(...arguments), this.mode = u.light, this.connected = !1, this.compact = !1, this.height = 0;
  }
  connectedCallback() {
  ...
  drawPopover() {
    const e = this.mode === "light" ? "#D9D9D9" : "#808080", a = this.height, r = 13, o = 8, t = 344, c = a, n = 12, D = n / 2, le = `
      ...
      </linearGradient>`, ge = (Y, B, P) => `
      L ${Y - P} ${B} 
      L ${Y} 1
      L ${Y + P} ${B}`, Me = this.compact ? t - 30 : 300, Ie = `
    ...
    `;
    return `data:image/svg+xml;base64,${be(Ie)}`;
  }
  render() {
    return s`<style>
        :host {
...
const he = 32, Te = 32, f = 138, H = s`<div class="loading-spinner-container">
...
let C = class extends I {
  ...
  disconnectedCallback() {
    ...
    const e = this.shadowRoot.querySelector("button");
    (a = this.resizeObserver) == null || a.unobserve(e);
  }
  render() {
    const e = () => this.status === U.pending && this.connected ? s`${H} <slot></slot>` : this.status === U.pending ? H : !this.connected && ["success", "error"].includes(this.status) ? "" : s`<slot></slot>`, a = this.status !== "pending" && !this.connected, r = this.connected;
    return s`
      <button
        @click=${this.onClick}
        class=${T({
...
let Z = class extends I {
  ...
  render() {
    const e = () => this.timestamp ? s`<div class="timestamp">${ce(this.timestamp)}</div>` : "", a = `${this.icon ? "30px" : ""} 1fr ${this.timestamp ? "60px" : ""}`;
    return s`<div class="card" style=${ne({ gridTemplateColumns: a })}>
      <i></i>
      <div class="content">
...
var Se = Object.defineProperty, we = Object.getOwnPropertyDescriptor, G = (e, a, r, o) => {
  for (var t = o > 1 ? void 0 : o ? we(a, r) : a, c = e.length - 1, n; c >= 0; c--)
    (n = e[c]) && (t = (o ? n(a, r, t) : n(t)) || t);
  return o && t && Se(a, r, t), t;
};
...
], y.prototype, "appearanceId", 2);
y = O([
  p("radix-account")
], y);
var We = Object.defineProperty, Oe = Object.getOwnPropertyDescriptor, h = (e, a, r, o) => {
  for (var t = o > 1 ? void 0 : o ? Oe(a, r) : a, c = e.length - 1, n; c >= 0; c--)
    (n = e[c]) && (t = (o ? n(a, r, t) : n(t)) || t);
  return o && t && We(a, r, t), t;
};
let x = class extends I {
  constructor() {
    super(...arguments), this.mode = u.light, this.type = "dataRequest", this.status = "pending", this.showCancel = !1, this.timestamp = "", this.id = "", this.transactionIntentHash = "";
  }
  render() {
    const e = this.getIconFromStatus(), a = this.getStylingFromStatus(), r = {
      sendTransaction: {
  ...
  renderTxIntentHash() {
    return this.transactionIntentHash ? s`<div class="transaction">
          ...
          <radix-link
            ...
            displayText="${se(this.transactionIntentHash)}"
            mode=${this.mode}
            @click=${(e) => {
      e.preventDefault(), this.dispatchEvent(
        new CustomEvent("onLinkClick", {
...
x = h([
  p("radix-request-card")
], x);
var Qe = Object.defineProperty, fe = Object.getOwnPropertyDescriptor, X = (e, a, r, o) => {
  for (var t = o > 1 ? void 0 : o ? fe(a, r) : a, c = e.length - 1, n; c >= 0; c--)
    (n = e[c]) && (t = (o ? n(a, r, t) : n(t)) || t);
  return o && t && Qe(a, r, t), t;
};
...
X([
  i({ type: Array })
], k.prototype, "requestItems", 2);
k = X([
  p("radix-request-cards")
], k);
var Ge = Object.defineProperty, Ye = Object.getOwnPropertyDescriptor, v = (e, a, r, o) => {
  for (var t = o > 1 ? void 0 : o ? Ye(a, r) : a, c = e.length - 1, n; c >= 0; c--)
    (n = e[c]) && (t = (o ? n(a, r, t) : n(t)) || t);
  return o && t && Ge(a, r, t), t;
};
let A = class extends I {
  constructor() {
    super(...arguments), this.mode = u.light, this.isMobile = !1, this.status = U.default, this.isWalletLinked = !1, this.isExtensionAvailable = !1, this.requestItems = [];
  }
  render() {
    let e = this.renderConnectTemplate();
    return this.isMobile ? e = this.renderMobileTemplate() : this.isExtensionAvailable ? this.isWalletLinked ? this.status === U.pending && (e = this.renderRequestItemsTemplate()) : e = this.renderCeNotLinkedTemplate() : e = this.renderCeNotInstalledTemplate(), s`
      <div class="wrapper connect-your-wallet">
        <img class="logo" src=${Ee} />
...
var Xe = Object.defineProperty, Be = Object.getOwnPropertyDescriptor, w = (e, a, r, o) => {
  for (var t = o > 1 ? void 0 : o ? Be(a, r) : a, c = e.length - 1, n; c >= 0; c--)
    (n = e[c]) && (t = (o ? n(a, r, t) : n(t)) || t);
  return o && t && Xe(a, r, t), t;
};
      ...
      >
        <div class="placeholder">
          <div
            class="avatar"
            style=${ne({
      backgroundImage: `url(${d(this.avatarUrl)})`
    })}
          ></div>
        </div>
        <div class="content">
...
`;
var Pe = Object.defineProperty, He = Object.getOwnPropertyDescriptor, V = (e, a, r, o) => {
  for (var t = o > 1 ? void 0 : o ? He(a, r) : a, c = e.length - 1, n; c >= 0; c--)
    (n = e[c]) && (t = (o ? n(a, r, t) : n(t)) || t);
  return o && t && Pe(a, r, t), t;
};
  ...
  render() {
    return s` <div class="header">Sharing with ${this.dAppName}</div>
      <div class="content">
        ...
        <div>
          ${(this.accounts || []).map(
      ({ label: e, address: a, appearanceId: r }) => s`<radix-account
                label=${e}
                address=${a}
                appearanceId=${r}
              ></radix-account>`
...
b.styles = [
  ...
  M`
      ...
      #update-data::before {
        -webkit-mask-image: url(${d(re)});
        mask-image: url(${d(re)});
      }

      #logout::before {
        -webkit-mask-image: url(${d(ie)});
        mask-image: url(${d(ie)});
      }
    `
];
...
b = V([
  p("radix-sharing-page")
], b);
var Je = Object.defineProperty, Ke = Object.getOwnPropertyDescriptor, Q = (e, a, r, o) => {
  for (var t = o > 1 ? void 0 : o ? Ke(a, r) : a, c = e.length - 1, n; c >= 0; c--)
    (n = e[c]) && (t = (o ? n(a, r, t) : n(t)) || t);
  return o && t && Je(a, r, t), t;
};
...
let l = class extends I {
  ...
  connectButtonTemplate() {
    ...
    return s` <radix-button
      ...
      @onResize=${(a) => {
      this.compact = a.detail.offsetWidth === 40;
    }}
  ...
  popoverTemplate() {
    return this.showPopover ? s` <radix-popover
      mode="${this.mode}"
      ?connected=${this.connected}
      ?compact=${this.compact}
      class=${Ne({ popover: !0, "show-popover": this.showPopover })}
    >
      ${this.connected ? s`
            <radix-tabs-menu

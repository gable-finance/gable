...
// node_modules/@radixdlt/radix-dapp-toolkit/dist/connect-button-cf1a7b0e.mjs
var at = {
...
var Dt = (t, e, n, r) => {
  for (var o = r > 1 ? void 0 : r ? ht(e, n) : e, i = t.length - 1, a; i >= 0; i--)
    (a = t[i]) && (o = (r ? a(e, n, o) : a(o)) || o);
  return r && o && xt(e, n, o), o;
};
...
var N = {
  radixBlue: css`#060F8F`,
  radixGrey1: css`#003057`,
  radixGrey2: css`#8A8FA4`,
  radixGrey3: css`#CED0D6`,
  radixGrey4: css`#E2E5ED`,
  radixGrey5: css`#F4F5F9`
};
var Nt = Object.defineProperty;
var At = Object.getOwnPropertyDescriptor;
var vt = (t, e, n, r) => {
  for (var o = r > 1 ? void 0 : r ? At(e, n) : e, i = t.length - 1, a; i >= 0; i--)
    (a = t[i]) && (o = (r ? a(e, n, o) : a(o)) || o);
  return r && o && Nt(e, n, o), o;
};
...
V.styles = css`
    :host {
      ...
      border-radius: 12px;
      position: absolute;
      background: ${N.radixGrey5};
      box-shadow: 0px 4px 9px rgba(0, 0, 0, 0.25);
      border-radius: 12px;
      border: 1px solid ${N.radixGrey4};
...
var A = (t, e, n, r) => {
  for (var o = r > 1 ? void 0 : r ? wt(e, n) : e, i = t.length - 1, a; i >= 0; i--)
    (a = t[i]) && (o = (r ? a(e, n, o) : a(o)) || o);
  return r && o && jt(e, n, o), o;
};
var x = class extends LitElement {
  constructor() {
    super(...arguments), this.loading = false, this.gradient = false, this.logo = false, this.fullWidth = false, this.text = false, this.secondary = false, this.mb = 0, this.fontWeight = 500, this.alignSelf = "auto";
  }
  onClick(t) {
    this.dispatchEvent(
  ...
  render() {
    return html` <button
      ...
      fontWeight: `${this.fontWeight}`
        ...
        @click=${this.onClick}
      >
        ${this.loading ? html`<loading-spinner />` : html`<slot></slot>`}</button
      ><slot></slot>`;
  }
};
x.styles = css`
    ...
    button.gradient {
      background: url(${unsafeCSS(zt)}) no-repeat;
...
], x.prototype, "fontWeight", 2);
A([
  property({
    type: String
  })
], x.prototype, "alignSelf", 2);
x = A([
...
var Zt = "data:image/svg+xml;base64,";
var Lt = "data:image/svg+xml;base64,";
var Ge = {
  givenName: "givenName",
...
var X = (t, e, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Gt(e, n) : e, i = t.length - 1, a; i >= 0; i--)
    (a = t[i]) && (o = (r ? a(e, n, o) : a(o)) || o);
  return r && o && Ot(e, n, o), o;
};
var Et = {
  [B.dataRequest]: "Data request",
  [B.loginRequest]: "Login request",
  [B.sendTransaction]: "Send transaction"
};
var w = class extends LitElement {
  constructor() {
    super(...arguments), this.features = { cancel: false };
  }
  onCancel() {
    var t;
    this.dispatchEvent(
      new CustomEvent("onCancel", {
        detail: { id: (t = this.item) == null ? void 0 : t.id },
        bubbles: true,
        composed: true
      })
    );
  ...
  actionsTemplate() {
    var t, e;
    return this.item && ["dataRequest", "loginRequest"].includes(this.item.type) && this.item.status === "pending" && this.features.cancel ? html`<button @click=${this.onCancel} class="text cancel">
        Cancel
      </button>` : ((t = this.item) == null ? void 0 : t.status) === "fail" ? html`<span class="text error">${this.item.error}</span>` : ((e = this.item) == null ? void 0 : e.type) === "sendTransaction" && this.item.status === "success" && this.transactionExplorerBaseUrl ? html`<a
        target="_blank"
        href="${this.transactionExplorerBaseUrl}${this.item.transactionIntentHash}"
  ...
  render() {
    var t;
    return this.item ? html`<div class="wrapper main">
      <div class="wrapper type-status">
        <span class="icon ${(t = this.item) == null ? void 0 : t.status}"></span>
        <span class="text type"
          >${Et[this.item.type]}</span
        >
      </div>
...
w.styles = css`
    ...
    .icon.pending::before {
      content: url(${unsafeCSS(Tt)});
    }
    .icon.success::before {
      content: url(${unsafeCSS(Zt)});
    }
    .icon.fail::before {
      content: url(${unsafeCSS(Lt)});
      position: relative;
      top: -0.1rem;
    }
  `;
...
var Wt = "data:image/svg+xml;base64,";
var Xt = "data:image/svg+xml;base64,";
var U = function(t, e) {
...
function Ct(t, e, n, r) {
  ...
  return new (n || (n = Promise))(function(i, a) {
    ...
    function c(l) {
      l.done ? i(l.value) : o(l.value).then(u, s);
    }
...
function Yt(t, e, n) {
  ...
  function s(M) {
    M.value instanceof j ? Promise.resolve(M.value.v).then(c, l) : m(i[0][2], M);
  }
  function c(M) {
    u("next", M);
  }
  ...
  function m(M, b) {
    M(b), i.shift(), i.length && u(i[0][0], i[0][1]);
  }
}
function Bt(t) {
  if (!Symbol.asyncIterator)
  ...
  return e ? e.call(t) : (t = typeof Z == "function" ? Z(t) : t[Symbol.iterator](), n = {}, r("next"), r("throw"), r("return"), n[Symbol.asyncIterator] = function() {
    return this;
  }, n);
  function r(i) {
    n[i] = t[i] && function(a) {
    ...
    if (!this.closed) {
      ...
      if (a)
        if (this._parentage = null, Array.isArray(a))
          try {
            for (var u = Z(a), s = u.next(); !s.done; s = u.next()) {
              var c = s.value;
              c.remove(this);
            }
          } catch (f) {
      ...
      if (d2(l))
        try {
          ...
          i = f instanceof k ? f.errors : [f];
        }
      var m = this._finalizers;
      if (m) {
        this._finalizers = null;
        try {
          for (var M = Z(m), b = M.next(); !b.done; b = M.next()) {
            var v = b.value;
            try {
              et(v);
            } catch (f) {
              i = i ?? [], f instanceof k ? i = W(W([], L(i)), L(f.errors)) : i.push(f);
            }
          }
        } catch (f) {
          r = { error: f };
...
C.EMPTY;
function st(t) {
  return t instanceof C || t && "closed" in t && d2(t.remove) && d2(t.add) && d2(t.unsubscribe);
}
function et(t) {
  d2(t) ? t() : t.unsubscribe();
}
var ut = {
...
var Qt = {
  setTimeout: function(t, e) {
    for (var n = [], r = 2; r < arguments.length; r++)
      n[r - 2] = arguments[r];
    return setTimeout.apply(void 0, W([t, e], L(n)));
  },
...
var q = function(t) {
  ...
  function e(n) {
    ...
    return r.isStopped = false, n ? (r.destination = n, st(n) && n.add(r)) : r.destination = Rt, r;
  }
...
var Vt = Function.prototype.bind;
function Q(t, e) {
  return Vt.call(t, e);
}
var Ut = function() {
...
var J = function(t) {
  ...
  function e(n, r, o) {
    ...
    if (d2(n) || !n)
      ...
      var u;
      i && ut.useDeprecatedNextContext ? (u = Object.create(n), u.unsubscribe = function() {
        return i.unsubscribe();
      }, a = {
        next: n.next && Q(n.next, u),
        error: n.error && Q(n.error, u),
        complete: n.complete && Q(n.complete, u)
      }) : a = n;
    }
    return i.destination = new Ut(a), i;
  }
  return e;
}(q);
function S(t) {
...
function Ft(t) {
  return t.length === 0 ? dt : t.length === 1 ? t[0] : function(e) {
...
var I = function() {
  ...
  return t.prototype.lift = function(e) {
    ...
    var o = this, i = Kt(e) ? e : new J(e, n, r);
    return Ht(function() {
    ...
    var r = this;
    return n = rt(n), new n(function(o, i) {
      var a = new J({
        next: function(u) {
          try {
            e(u);
    ...
    var n = this;
    return e = rt(e), new e(function(r, o) {
      var i;
...
function rt(t) {
  var e;
  return (e = t ?? ut.Promise) !== null && e !== void 0 ? e : Promise;
}
function qt(t) {
  return t && d2(t.next) && d2(t.error) && d2(t.complete);
}
function Kt(t) {
  return t && t instanceof q || qt(t) && st(t);
}
function $t(t) {
  return d2(t == null ? void 0 : t.lift);
}
function Y(t) {
  return function(e) {
    if ($t(e))
...
function O(t, e, n, r, o) {
  return new _t(t, e, n, r, o);
}
var _t = function(t) {
  F(e, t);
  function e(n, r, o, i, a, u) {
    var s = t.call(this, n) || this;
    return s.onFinalize = a, s.shouldUnsubscribe = u, s._next = r ? function(c) {
      try {
        r(c);
      } catch (l) {
        n.error(l);
...
function te(t) {
  return d2(t == null ? void 0 : t.then);
}
function ee(t) {
  return d2(t[K]);
}
function ne(t) {
  return Symbol.asyncIterator && d2(t == null ? void 0 : t[Symbol.asyncIterator]);
}
function re(t) {
    ...
    return ct(this, function(i) {
      switch (i.label) {
        ...
        case 2:
          return [4, j(e.read())];
        case 3:
          return n = i.sent(), r = n.value, o = n.done, o ? [4, j(void 0)] : [3, 5];
        case 4:
          return [2, i.sent()];
        case 5:
          return [4, j(r)];
...
function se(t) {
  return d2(t == null ? void 0 : t.getReader);
}
function $(t) {
  if (t instanceof I)
    return t;
...
function Me(t) {
  return new I(function(e) {
    var n, r;
    try {
      for (var o = Z(t), i = o.next(); !i.done; i = o.next()) {
        var a = i.value;
...
function ge(t, e) {
  ...
  return Ct(this, void 0, void 0, function() {
    ...
    return ct(this, function(s) {
      switch (s.label) {
        case 0:
          s.trys.push([0, 5, 6, 11]), n = Bt(t), s.label = 1;
        case 1:
          return [4, n.next()];
        case 2:
          if (r = s.sent(), !!r.done)
...
function ye(t, e) {
  return be(e) ? t.apply(void 0, W([], L(e))) : t(e);
}
function me(t) {
...
function xe(t, e, n, r, o, i, a, u) {
  var s = [], c = 0, l = 0, m = false, M = function() {
    m && !s.length && !c && e.complete();
  }, b = function(f) {
    return c < r ? v(f) : s.push(f);
  }, v = function(f) {
    i && e.next(f), c++;
    var _ = false;
    $(n(f, l++)).subscribe(O(e, function(T) {
      o == null || o(T), i ? b(T) : e.next(T);
    }, function() {
      _ = true;
    }, void 0, function() {
      if (_)
  ...
  return t.subscribe(O(e, b, function() {
    m = true, M();
  })), function() {
    u == null || u();
  };
...
function ft(t, e, n) {
  return n === void 0 && (n = 1 / 0), d2(e) ? ft(function(r, o) {
    return gt(function(i, a) {
      return e(r, i, o, a);
    })($(t(r, o)));
  }, n) : (typeof e == "number" && (n = e), Y(function(r, o) {
    return xe(r, o, t, n);
  }));
}
var he = ["addListener", "removeListener"];
var De = ["addEventListener", "removeEventListener"];
var Ne = ["on", "off"];
function R(t, e, n, r) {
  if (d2(n) && (r = n, n = void 0), r)
    return R(t, e, n).pipe(me(r));
  var o = L(ze(t) ? De.map(function(u) {
    return function(s) {
      return t[u](e, s, n);
    };
  }) : Ae(t) ? he.map(it(t, e)) : ve(t) ? Ne.map(it(t, e)) : [], 2), i = o[0], a = o[1];
  if (!i && Mt(t))
...
function Ae(t) {
  return d2(t.addListener) && d2(t.removeListener);
}
function ve(t) {
  return d2(t.on) && d2(t.off);
}
function ze(t) {
  return d2(t.addEventListener) && d2(t.removeEventListener);
}
function ot(t, e) {
  return Y(function(n, r) {
    var o = 0;
...
function Ie(t, e, n) {
  var r = d2(t) || e || n ? { next: t, error: e, complete: n } : t;
  return r ? Y(function(o, i) {
    var a;
    (a = r.subscribe) === null || a === void 0 || a.call(r);
    var u = true;
    o.subscribe(O(i, function(s) {
      var c;
      (c = r.next) === null || c === void 0 || c.call(r, s), i.next(s);
    }, function() {
      var s;
      u = false, (s = r.complete) === null || s === void 0 || s.call(r), i.complete();
    }, function(s) {
      var c;
      u = false, (c = r.error) === null || c === void 0 || c.call(r, s), i.error(s);
    }, function() {
      var s, c;
      u && ((s = r.unsubscribe) === null || s === void 0 || s.call(r)), (c = r.finalize) === null || c === void 0 || c.call(r);
    }));
  }) : dt;
}
...
var h = (t, e, n, r) => {
  for (var o = r > 1 ? void 0 : r ? we(e, n) : e, i = t.length - 1, a; i >= 0; i--)
    (a = t[i]) && (o = (r ? a(e, n, o) : a(o)) || o);
  return r && o && je(e, n, o), o;
};
var y = class extends LitElement {
  constructor() {
    super(), this.connected = false, this.loading = false, this.showNotification = false, this.showPopover = false, this.connecting = false, this.requestItems = [], this.accounts = [], this.personaData = [], this.explorer = {
      baseUrl: "https://betanet-dashboard.radixdlt.com/",
      transactionPath: "transaction/",
      accountsPath: "account/"
    }, this.dAppName = "", this.personaLabel = "", this.subscriptions = new C(), this.fontGoogleApiHref = "https://fonts.googleapis.com/css?family=IBM+Plex+Sans:400,600", this.injectFontCSS(), this.subscriptions.add(
      R(window, "click").pipe(
        ot(() => this.showPopover),
        ot((t) => !this.contains(t.target)),
        Ie(() => this.showPopover = false)
      ).subscribe()
    );
  }
  get hasSharedData() {
  ...
  togglePopover() {
    this.showPopover = !this.showPopover, this.showPopover && this.dispatchEvent(
  ...
  formatAccountAddress(t) {
    return `${t.slice(0, 4)}...${t.slice(-6)}`;
  }
  formatAccountLabel(t) {
    return t.length > 14 ? `${t.slice(0, 12).trimEnd()}...` : t;
  }
  connectButtonTemplate() {
    const t = this.connected ? "Connected" : "Connect";
    return html` <radix-button
      ...
      logo
      fullWidth
      >${this.loading ? "" : t}</radix-button
    >`;
  }
  requestItemsTemplate() {
    return this.requestItems.length === 0 ? "" : html`<div class="wrapper request-item-list">
      ${this.requestItems.slice(-3).reverse().map(
      (t) => html`<div class="wrapper request-item">
              <radix-request-item
                .item=${t}
                transactionExplorerBaseUrl="${this.explorer.baseUrl}${this.explorer.transactionPath}"
                @onCancel=${() => {
        this.dispatchEvent(
  ...
  connectTemplate() {
    return !this.connected && !this.connecting ? html`<div class="wrapper connect">
        <div class="wrapper connect-your-wallet">
          <img class="logo" src=${Pt} />
      ...
      this.dispatchEvent(
        ...
        <a
          class="link wallet"
          href=${at.links["What is a radix wallet?"]}
          target="_blank"
          >What is a Radix Wallet?</a
        >
      </div>` : "";
  }
  disconnectWalletTemplate() {
    return this.connected ? html`<radix-button
        text
        mb="0.5"
        alignSelf="center"
        @onClick=${() => {
  ...
  updateSharedDataTemplate() {
    return this.connected && this.accounts.length ? html`<radix-button
        secondary
        text
        mb="0"
        fontWeight="400"
  ...
  accountListTemplate() {
    return html`<div class="wrapper account-list">
      ${this.accounts.map(
      (t) => html`<div class="wrapper account gradient-${t.appearanceId}">
            <span class="text account-label"
              >${this.formatAccountLabel(t.label)}</span
            >
            <a
              class="text account-address"
              target="_blank"
              href="${this.explorer.baseUrl}${this.explorer.accountsPath}${t.address}"
              >${this.formatAccountAddress(t.address)}<span
                class="icon link"
              ></span
            ></a>
          </div>`
  ...
  sharedDataTemplate() {
    return this.accounts.length && this.connected ? html`<div class="wrapper sharing">
        ${this.accountListTemplate()}
      </div> ` : "";
  }
  personaTemplate() {
    return this.personaLabel && this.connected ? html`<span class="text sharing"
      ...
      (t) => html`<div class="text persona-data">${t.value}</div>`
    )}
          </div>
        </div>` : "";
  }
  popoverTemplate() {
    return this.showPopover ? html`<radix-popover class="popover"
  ...
  notificationTemplate() {
    return this.showNotification ? html`<span class="icon notification"></span>` : "";
  }
  render() {
    return html`
...
h([
  property({ type: Boolean })
], y.prototype, "showNotification", 2);
h([
  property({
    type: Boolean
  })
], y.prototype, "showPopover", 2);
h([
  property({
    type: Boolean
  })
], y.prototype, "connecting", 2);
h([
  property({ type: Array })
], y.prototype, "requestItems", 2);
h([
  property({ type: Array })
], y.prototype, "accounts", 2);
h([
  property({
    type: Array
  })
...
], y.prototype, "explorer", 2);
h([
  property({ type: String })
], y.prototype, "dAppName", 2);
h([
  property({ type: String })
], y.prototype, "personaLabel", 2);
y = h([
  customElement(at.elementTag)
], y);
export {
  y as ConnectButton,
  B as RequestItemType,
  Ee as RequestStatus,
  Ge as personaDataField
};
...
lit-html/development/directives/style-map.js:
   ...
   *)
*/
//# sourceMappingURL=connect-button-cf1a7b0e-2XVRXOQF.js.map

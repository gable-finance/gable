...
function bn(e) {
  if (gr.useDeprecatedSynchronousErrorHandling) {
    var t = !dn;
    if (t && (dn = { errorThrown: false, error: null }), e(), t) {
...
var br = function(e) {
  ...
  function t(n) {
    ...
    return r.isStopped = false, n ? (r.destination = n, Vi(n) && n.add(r)) : r.destination = Ra, r;
  }
...
var Ca = Function.prototype.bind;
function Bn(e, t) {
  return Ca.call(e, t);
}
var ka = function() {
...
var Fa = function(e) {
  ...
  return t.prototype.schedule = function(n, r) {
    ...
    if (!this.closed) {
      ...
      this.work = this.state = this.scheduler = null, this.pending = false, wn(o, this), r != null && (this.id = this.recycleAsyncId(i, r, null)), this.delay = null, e.prototype.unsubscribe.call(this);
    }
  }, t;
}(Ma);
var ui = function() {
...
function lu(e, t, n, r, i, o, s, a) {
  var l = [], u = 0, d = 0, m = false, y = function() {
...
var du = ["addListener", "removeListener"];
var hu = ["addEventListener", "removeEventListener"];
var pu = ["on", "off"];
function Me(e, t, n, r) {
...
function gu(e, t, n, r, i) {
  return function(o, s) {
    ...
    o.subscribe(ie(s, function(d) {
      var m = u++;
      l = a ? e(l, d, m) : (a = true, d), r && s.next(l);
    }, i && function() {
...
function Au(e, t) {
  return pe(gu(e, t, arguments.length >= 2, true));
}
function Jt(e, t) {
  return pe(function(n, r) {
    var i = null, o = 0, s = false, a = function() {
...
function B(e, t, n) {
  ...
  return r ? pe(function(i, o) {
    ...
    i.subscribe(ie(o, function(l) {
      ...
      var l;
      a = false, (l = r.complete) === null || l === void 0 || l.call(r), o.complete();
    }, function(l) {
      var u;
      a = false, (u = r.error) === null || u === void 0 || u.call(r, l), o.error(l);
    }, function() {
      var l, u;
  ...
  return pe(function(r, i) {
    for (var o = e.length, s = new Array(o), a = e.map(function() {
      ...
      ze(e[m]).subscribe(ie(i, function(y) {
        s[m] = y, !l && !a[m] && (a[m] = true, (l = a.every(Nt)) && (a = null));
      }, rr));
    }, d = 0; d < o; d++)
      u(d);
...
var Cu = function(e) {
  return function(t) {
    return pt(pt([], On(t), false), [e], false);
  };
};
var mo = function(e) {
...
var yo = function(e) {
  return e.reduce(function(t, n) {
    return n.isErr() ? t.isErr() ? Ie(pt(pt([], On(t.error), false), [n.error], false)) : Ie([n.error]) : t.isErr() ? t : re(pt(pt([], On(t.value), false), [n.value], false));
  }, re([]));
};
var $u = function(e) {
  ...
  function t(i, o) {
    return function() {
      for (var s = [], a = 0; a < arguments.length; a++)
        s[a] = arguments[a];
      try {
        var l = i.apply(void 0, pt([], On(s), false));
        return re(l);
      } catch (u) {
        return Ie(o ? o(u) : u);
      }
...
(function(e, t) {
  ...
  Z[N] = Z[q] = Z[Q] = Z[De] = Z[Lt] = Z[Ut] = Z[nn] = Z[fs] = Z[ds] = true, Z[a] = Z[l] = Z[He] = Z[d] = Z[_] = Z[m] = Z[y] = Z[v] = Z[p] = Z[A] = Z[g] = Z[ne] = Z[E] = Z[ue] = Z[ce] = false;
  var jr = typeof pn == "object" && pn && pn.Object === Object && pn, ys = typeof self == "object" && self && self.Object === Object && self, je = jr || ys || Function("return this")(), Nr = t && !t.nodeType && t, qr = Nr && true && e && !e.nodeType && e, Lr = qr && qr.exports === Nr, jn = Lr && jr.process, Ur = function() {
    try {
  ...
  function Bs(c) {
    ...
    if (h < 0)
      return false;
    var b = f.length - 1;
    return h == b ? f.pop() : Cs.call(f, h, 1), --this.size, true;
  }
  function zs(c) {
    var f = this.__data__, h = an(f, c);
  ...
  function Yr(c, f, h, b, W) {
    return c === f ? true : c == null || f == null || !Wt(c) && !Wt(f) ? c !== c && f !== f : ua(c, f, h, b, Yr, W);
  }
  function ua(c, f, h, b, W, P) {
    ...
    return te ? (P || (P = new Ve()), ha(c, f, h, b, W, P)) : false;
  }
  function ca(c) {
    if (!ni(c) || ga(c))
      return false;
  ...
  function Jr(c, f, h, b, W, P) {
    ...
    if (K && P.get(f))
      return K == f;
    var le = -1, _e = true, te = h & o ? new sn() : void 0;
  ...
  function ha(c, f, h, b, W, P) {
    ...
    if (ye && !Ye) {
      ...
      ln != fn && "constructor" in c && "constructor" in f && !(typeof ln == "function" && ln instanceof ln && typeof fn == "function" && fn instanceof fn) && (ye = false);
    }
...
var pi = (e, t) => Object.keys(e).length === 0 || e.ongoingAccountsWithoutProofOfOwnership || e.ongoingPersonaData ? re(t ? {
  ...e,
  usePersona: {
...
var qu = (e) => {
  const t = e.key, n = e.subjects, r = e.logger, i = e.connectButtonClient, o = e.walletClient, s = e.storageClient, a = e.useDoneCallback, l = e.onDisconnectCallback, u = e.getState, d = e.useCache ?? true, m = new Re(), y = () => s.getData(t).map((_) => (_ && (r == null || r.debug("readFromStorage")), _)), v = (_) => s.setData(t, _).map(() => {
    ...
    n.setState.next({ state: Vn, persist: true });
    ...
    (N) => $(_).andThen((q) => pi(q, N.persona)).asyncAndThen(
      (q) => hi(q, {
        ...
        const {
          ...
          x({ ...Q, connected: true, sharedData: Ut }, true);
        };
        return a || nn(), {
          data: Q,
          done: nn
        };
      }).mapErr((Q) => (x({ connected: false }, true), Q))
    )
  )));
  m.add(
...
var Lu = () => ({
  ...
  loading: new Ue(false),
  connected: new wt(1),
  requestItems: new Ue([]),
  onCancelRequestItem: new ve(),
  accounts: new Ue([]),
  connecting: new Ue(false),
  onShowPopover: new ve(),
  showNotification: new Ue(false),
  personaLabel: new Ue(""),
  personaData: new Ue([])
});
var Uu = (e) => {
  import("./connect-button-cf1a7b0e-P7CRC5RN.js");
...
var Zu = (e) => {
  const t = e.logger, n = e.requestItemClient || Fu({
    ...
    usePersona: v,
    reset: x = { accounts: false, personaData: false }
  }) => {
    const p = { reset: x };
    if (l) {
...
var zu = (e, t, n) => t in e ? Bu(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
var Kt = (e, t, n) => (zu(e, typeof t != "symbol" ? t + "" : t, n), n);
var or = function(e, t) {
...
var Ir = function(e) {
  ...
  function t(n) {
    var r = e.call(this) || this;
    return r.isStopped = false, n ? (r.destination = n, _o(n) && n.add(r)) : r.destination = Xu, r;
  }
  return t.create = function(n, r, i) {
    return new kt(n, r, i);
  }, t.prototype.next = function(n) {
...
var Yu = Function.prototype.bind;
function Yn(e, t) {
  return Yu.call(e, t);
}
var Ju = function() {
...
var uc = function(e) {
  ...
  return t.prototype.schedule = function(n, r) {
    ...
    if (!this.closed) {
      var n = this, r = n.id, i = n.scheduler, o = i.actions;
      this.work = this.state = this.scheduler = null, this.pending = false, In(o, this), r != null && (this.id = this.recycleAsyncId(i, r, null)), this.delay = null, e.prototype.unsubscribe.call(this);
    }
  }, t;
}(ac);
var gi = function() {
...
function Zo(e) {
  ...
  var t = e.connector, n = t === void 0 ? function() {
    return new Qe();
  } : t, r = e.resetOnError, i = r === void 0 ? true : r, o = e.resetOnComplete, s = o === void 0 ? true : o, a = e.resetOnRefCountZero, l = a === void 0 ? true : a;
  return function(u) {
    var d, m, y, v = 0, x = false, p = false, A = function() {
      m == null || m.unsubscribe(), m = void 0;
    }, O = function() {
      A(), d = y = void 0, x = p = false;
    }, g = function() {
      var z = d;
    ...
    return xe(function(z, U) {
      ...
      U.add(function() {
        ...
        error: function(E) {
          p = true, A(), m = Qn(O, i, E), ne.error(E);
        },
        complete: function() {
          x = true, A(), m = Qn(O, s), ne.complete();
        }
      }), it(z).subscribe(d));
    })(u);
  };
...
var Lc = (e) => e.outgoingMessageSubject.pipe(
  Vt((t) => ({
...
(function(e) {
  (function(t, n) {
    ...
    function a(p) {
      return p === "debug" && (p = "log"), typeof console === n ? false : p === "trace" && r ? s : console[p] !== void 0 ? o(console, p) : console.log !== void 0 ? o(console, "log") : t;
    }
    function l(p, A) {
    ...
    function m(p, A, O) {
      ...
      g.name = p, g.levels = {
        ...
        if (typeof $ == "string" && g.levels[$.toUpperCase()] !== void 0 && ($ = g.levels[$.toUpperCase()]), typeof $ == "number" && $ >= 0 && $ <= g.levels.SILENT) {
          if (z = $, ce !== false && ne($), l.call(g, $, p), typeof console === n && $ < g.levels.SILENT)
            return "No console available for logging";
        } else
          throw "log.setLevel() called with invalid level: " + $;
      }, g.setDefaultLevel = function($) {
        A = $, E() || g.setLevel($, false);
      }, g.resetLevel = function() {
        g.setLevel(A, false), ue();
      ...
      var Te = E();
      Te == null && (Te = A), g.setLevel(Te, false);
    }
    var y = new m(), v = {};
...
var Se = Wo.exports;
var Uc = (e) => e.incomingMessageSubject.pipe(
  Ot((t) => {
...
var Mc = (e) => e.dispatchEventSubject.pipe(
...
var zc = function(e) {
  return function(t) {
    return mt(mt([], Pn(t), false), [e], false);
  };
};
var zo = function(e) {
  return e.reduce(function(t, n) {
...
var Ko = function(e) {
  return e.reduce(function(t, n) {
    return n.isErr() ? t.isErr() ? Ee(mt(mt([], Pn(t.error), false), [n.error], false)) : Ee([n.error]) : t.isErr() ? t : Pe(mt(mt([], Pn(t.value), false), [n.value], false));
  }, Pe([]));
};
var Hc = function(e) {
  ...
  function t(i, o) {
    return function() {
      for (var s = [], a = 0; a < arguments.length; a++)
        s[a] = arguments[a];
      try {
        var l = i.apply(void 0, mt([], Pn(s), false));
        return Pe(l);
      } catch (u) {
        return Ee(o ? o(u) : u);
      }
...
var Gc = (/* @__PURE__ */ new Map()).set(yt.missingExtension, "extension could not be found").set(yt.rejectedByUser, "user rejected request").set(yt.canceledByUser, "user has canceled the request");
var $t = (e, t, n) => ({
  error: e,
  interactionId: t,
  message: n || Gc.get(e) || ""
});
var Yc = (e) => Ke.fromPromise(Ic(e), Vc).andThen(
  (t) => t
);
var Jc = (e, t) => e.messageLifeCycleEventSubject.pipe(
...
var be = (e) => ({ status: "valid", value: e });
var wi = (e) => e.status === "aborted";
var Si = (e) => e.status === "dirty";
var lr = (e) => e.status === "valid";
var xi = (e) => typeof Promise !== void 0 && e instanceof Promise;
var D;
(function(e) {
...
var Ti = (e, t) => {
  ...
  return { success: false, error: new Xt(e.common.issues) };
};
function j(e) {
  if (!e)
    return {};
...
var F = class {
  ...
  refine(t, n) {
    ...
    return this._refinement((i, o) => {
      ...
      return typeof Promise < "u" && s instanceof Promise ? s.then((l) => l ? true : (a(), false)) : s ? true : (a(), false);
    });
  }
  refinement(t, n) {
...
var nl = /^c[^\s-]{8,}$/i;
var rl = /^([a-f0-9]{8}-[a-f0-9]{4}-[1-5][a-f0-9]{3}-[a-f0-9]{4}-[a-f0-9]{12}|00000000-0000-0000-0000-000000000000)$/i;
var il = /^(([^<>()[\]\.,;:\s@\"]+(\.[^<>()[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i;
...
var fr = class dr extends F {
  ...
  gte(t, n) {
    return this.setLimit("min", t, true, D.toString(n));
  }
  gt(t, n) {
    return this.setLimit("min", t, false, D.toString(n));
  }
  lte(t, n) {
    return this.setLimit("max", t, true, D.toString(n));
  }
  lt(t, n) {
    return this.setLimit("max", t, false, D.toString(n));
  }
  setLimit(t, n, r, i) {
    return new dr({
      ...this._def,
...
function mr(e, t) {
  ...
  if (n === S.object && r === S.object) {
    ...
    return n === S.date && r === S.date && +e == +t ? { valid: true, data: e } : { valid: false };
}
...
var kn = class extends F {
  _parse(t) {
    const { ctx: n } = this._processInputParams(t);
    if (n.parsedType !== S.promise && n.common.async === false)
      return T(n, {
        code: w.invalid_type,
        expected: S.promise,
        received: n.parsedType
  ...
  Object.entries(e).reduce(
    (t, [n, r]) => {
      switch (n) {
        ...
        case we.reset: {
          const { accounts: i = false, personaData: o = false } = r;
          return !i && !o ? t : {
            ...t,
...
var Fi = (e) => (t, n = crypto.randomUUID()) => Pe({
  items: t,
  interactionId: n,
  metadata: e
});
...
var jd = (e) => `"${e}"`;
var Nd = (e, ...t) => typeof e == "number" ? t.length > 0 ? `Enum(${e}u8, ${t.join(", ")})` : `Enum(${e}u8)` : t.length > 0 ? `Enum("${e}", ${t.join(", ")})` : `Enum("${e}")`;
var qd = (...e) => `Tuple(${e.join(",")})`;
var Ld = (e, ...t) => (Hl(e, t), `Array<${e}>(${t.join(",")})`);
var Ud = (e, t, ...n) => `Map<${e},${t}>(${n.join(",")})`;
var G = (e) => `Address("${e}")`;
var Bt = (e) => typeof e == "string" ? `Bucket("${e}")` : `Bucket(${e}u32)`;
var Le = (e) => typeof e == "string" ? `Proof("${e}")` : `Proof(${e}u32)`;
var Md = (e) => `Expression("${e}")`;
var Fd = (e) => `Blob("${e}")`;
var _t = (e) => `Decimal("${e}")`;
var Zd = (e) => `PreciseDecimal("${e}")`;
var Wd = {
...
var Bd = (e) => `NonFungibleGlobalId("${e}")`;
var zd = (e) => `Bytes("${e}")`;
var Hl = (e, t) => {
  if (e === "String") {
...
var Ql = "[object Function]";
var Xl = "[object GeneratorFunction]";
var ef = typeof Ht == "object" && Ht && Ht.Object === Object && Ht;
var tf = typeof self == "object" && self && self.Object === Object && self;
var nf = ef || tf || Function("return this")();
function rf(e, t, n) {
  switch (n.length) {
    case 0:
      return e.call(t);
...
var sf = $r.hasOwnProperty;
var ss = $r.toString;
var Zi = nf.Symbol;
var af = $r.propertyIsEnumerable;
var Wi = Zi ? Zi.isConcatSpreadable : void 0;
var Bi = Math.max;
...
var If = ({ accounts: e = false, personaData: t = false }) => (n) => ({
  ...n,
...
var kf = (e, t, n) => t in e ? Cf(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
var tn = (e, t, n) => (kf(e, typeof t != "symbol" ? t + "" : t, n), n);
var $f = "https://rcnet.radixdlt.com".replace(/\/+$/, "");
var us = class {
  constructor(t = {}) {
...
var md = (/* @__PURE__ */ new Map()).set(11, "https://nebunet-gateway.radixdlt.com").set(12, "https://rcnet.radixdlt.com").set(32, "https://gilganet-gateway.radixdlt.com").set(33, "https://enkinet-gateway.radixdlt.com").set(34, "https://hammunet-gateway.radixdlt.com");
var yd = (e) => {
  const t = md.get(e);
  if (!t)
...
var bd = (e, t) => () => fe.fromPromise(
  ho(e),
  (n) => n
).map((n) => (t == null || t.debug("getState", n), n));
var _d = () => ({
  connected: new wt(1),
  accounts: new wt(1),
  persona: new wt(),
...
var Gd = ({ dAppDefinitionAddress: e, dAppName: t }, n, r) => {
  const {
    networkId: i = 1,
    providers: o,
    logger: s,

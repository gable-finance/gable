...
// node_modules/@radixdlt/radix-dapp-toolkit/dist/connect-button-761ff8de.mjs
var ue = {
...
var f = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Ae(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
...
var L = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? me(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && De(a, o, t), t;
};
var T = class extends LitElement {
  constructor() {
    super(...arguments), this.mode = u.light, this.connected = false, this.compact = false, this.height = 0;
  }
  connectedCallback() {
  ...
  drawPopover() {
    const e = this.mode === "light" ? "#D9D9D9" : "#808080", a = this.height, o = 13, i = 8, t = 344, d2 = a, n = 12, D = n / 2, se = `
...
var ze = 32;
var G = 138;
var P = html`<div class="loading-spinner-container">
...
var W = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? je(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
...
var y = class extends LitElement {
  ...
  render() {
    const e = () => this.status === k.pending && this.connected ? html`${P} <slot></slot>` : this.status === k.pending ? P : !this.connected && ["success", "error"].includes(this.status) ? "" : html`<slot></slot>`, a = this.status !== "pending" && !this.connected, o = this.connected;
    return html`
      <button
        @click=${this.onClick}
        class=${classMap({
...
y.styles = [
  ...
  css`
      ...
      button.logo::before {
        content: '';
        mask-image: url(${unsafeCSS(J)});
        -webkit-mask-image: url(${unsafeCSS(J)});
      }
      ...
      @container (width < ${G}px) {
        ...
        button.gradient {
          background-image: url(${unsafeCSS(Ze)});
          padding: 0;
        }
        button.logo::before {
          font-size: 16px;
...
var R = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? ke(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
...
var Z = class extends LitElement {
  ...
  render() {
    const e = () => this.timestamp ? html`<div class="timestamp">${de(this.timestamp)}</div>` : "", a = `${this.icon ? "30px" : ""} 1fr ${this.timestamp ? "60px" : ""}`;
    return html`<div class="card" style=${styleMap({ gridTemplateColumns: a })}>
      <i></i>
      <div class="content">
...
var Y = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Se(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
...
var O = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? We(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
...
var h = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Oe(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
...
var X = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Ge(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
...
var v = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Fe(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
...
var S = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Be(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && Xe(a, o, t), t;
};
...
var V = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? Pe(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
  ...
  render() {
    return html` <div class="header">Sharing with ${this.dAppName}</div>
      <div class="content">
        ...
        <div>
          ${(this.accounts || []).map(
      ({ label: e, address: a, appearanceId: o }) => html`<radix-account
                label=${e}
                address=${a}
                appearanceId=${o}
              ></radix-account>`
...
var l = (e, a, o, i) => {
  for (var t = i > 1 ? void 0 : i ? $e(a, o) : a, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(a, o, t) : n(t)) || t);
  return i && t && qe(a, o, t), t;
};
var s = class extends LitElement {
  constructor() {
    super(), this.theme = "radix-blue", this.dAppName = "", this.personaLabel = "", this.connected = false, this.status = k.default, this.loggedInTimestamp = "", this.showPopover = false, this.requestItems = [], this.accounts = [], this.personaData = [], this.isMobile = false, this.isWalletLinked = false, this.isExtensionAvailable = false, this.fullWidth = false, this.activeTab = "sharing", this.mode = "light", this.avatarUrl = "", this.compact = false, this.windowClickEventHandler = (e) => {
      this.showPopover && (this.contains(e.target) || (this.showPopover = false));
  ...
  popoverTemplate() {
    return this.showPopover ? html` <radix-popover
      mode="${this.mode}"
      ?connected=${this.connected}
...
lit-html/development/directives/style-map.js:
   ...
   *)
*/
//# sourceMappingURL=connect-button-761ff8de-L2VMO4IZ.js.map
